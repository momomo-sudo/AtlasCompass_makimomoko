...
class RegisterUserFormRequest extends FormRequest
{
    ...
    public function rules()
    {
        ...
        return [
            ...
            'datetime_validation' => 'required|date|before:today|after_or_equal:2000-01-01',// 正しい日付かどうかをチェック
    ...
    public function messages()
    {
        return [
            ...
            'datetime_validation.required' => '入力必須項目です。',
            'datetime_validation.after' => '2000年1月1日から今日までを指定してください。',
            'datetime_validation.before' => '今日までを指定してください。',
